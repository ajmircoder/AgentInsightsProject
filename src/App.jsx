    ...
    <div>
      {quizStarted ? <Quiz quizStarted={quizStarted} setQuizStarted={setQuizStarted} /> :
        <div className="center-div">
          <div>
          <p className=' mb-2 text-xl font-bold'>Welcome to my quiz!</p>
          ...
          to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300
           dark:focus:ring-green-800 font-medium rounded-lg text-xl px-5 py-2.5 text-center me-2">Are You Ready</button>
          </div>
